...
- [ ] 3.1 Add bootstrap, launcher, sync, and tooling-currency tests for the
...
- [ ] 3.2 Add workflow-contract tests for discovery of every shipped reusable
  workflow, deterministic error reporting, and a newly discovered workflow.
- [ ] 3.3 Run focused tests, the full Python suite, reusable-workflow contract
  validation, strict OpenSpec validation, and Markdown structure checks.

## 4. Documentation

- [ ] 4.1 Update `docs/testing.md`, `docs/setup-guide.md`, `PANOPTICON.md`, and
